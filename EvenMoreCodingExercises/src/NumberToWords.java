...
public class NumberToWords {
    public static void numberToWords(int number){
       ...
       int checkZeros = getDigitCount(number);
       //System.out.println("Number of digits in " + number + " = " +checkZeros);

        number = reverse(number);

       int numberOfTimesLoopRuns = 0;
        ...
        int addZeros = checkZeros - numberOfTimesLoopRuns;
        if (addZeros > 0){
